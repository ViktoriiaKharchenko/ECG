...
datasetPath = 'drive/MyDrive/Colab Notebooks/datasets/NvsAFScaled/dataN_AFScaled.txt'
resultPath = 'drive/MyDrive/Colab Notebooks/datasets/NvsAFScaled/typeN_AFcaled.txt'
...
datasetPath = 'drive/MyDrive/Colab Notebooks/datasets/NvsAFScaled/dataValidationN_AFScaled.txt'
resultPath = 'drive/MyDrive/Colab Notebooks/datasets/NvsAFScaled/typeValidationN_AFScaled.txt'
...
# Создаём пустую сеть
model = create_model()
checkpointer = ModelCheckpoint(filepath='drive/MyDrive/Colab Notebooks/models/Best_AFvsN_scaled_model8.h5', monitor='val_accuracy', verbose=1, save_best_only=True)
...
model.save('drive/MyDrive/Colab Notebooks/models/AFvsN_scaled_model8.h5')
...
model = keras.models.load_model('drive/MyDrive/Colab Notebooks/models/Best_AFvsN_scaled_model8.h5')
...
model = keras.models.load_model('drive/MyDrive/Colab Notebooks/models/Best_AFvsN_scaled_model7.h5')
